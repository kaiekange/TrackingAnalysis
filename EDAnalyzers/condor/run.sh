...
cmsRun ${CfgFile} RunOnData=${RunOnData} GlobalTag=${GlobalTag} EventScale=${EventScale} EventModulo=${EventModulo} InputFile="${InputFile}" OutputFile="${OutputFile}" &> ${LogFile}
