...
/* const TString datatype = "ZeroBias"; */
...
/* }; */
/* const TString anaroot = "/user/kakang/IPres/CMSSW_14_0_10/src/TrackingAnalysis/scripts/tuples/ZeroBias_data2022.root"; */


/* // JetHT */
const TString all_era = "BC";
const TString datatype = "JetHT";
const TString datatype_text = "High-q^{2} multi-jet events";
const string filepath[] = {
    "/pnfs/iihe/cms/store/user/kakang/Run3TrackingAnalysis/Ntuple/Track-v20250328_noBS/JetHT/Run2022B_22Sep2023_v1_MINIAOD/250723_115916/",
    "/pnfs/iihe/cms/store/user/kakang/Run3TrackingAnalysis/Ntuple/Track-v20250328_noBS/JetHT/Run2022C_22Sep2023_v1_MINIAOD/250723_115925/"
};
const TString anaroot = "/user/kakang/IPres/CMSSW_14_0_10/src/TrackingAnalysis/scripts/tuples/JetHT_data2022.root";
