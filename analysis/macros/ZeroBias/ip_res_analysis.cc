...
float fit_draw(TH1F* hist, TString figpath) {
    ...
    write_text(0.68, 0.35, Form("reso = %.*f", std::max(0, 2-(int)floor(log10(abs(sigma3.getVal())))), reso));
    CMS_lumi_sub(c1);
...
int ip_res_analysis(int idx) {
    ...
    TH1F *h_d0_pt_loeta = new TH1F("h_d0_pt_loeta", "", 200, d0_pt_loeta_mean-8*d0_pt_loeta_stddev, d0_pt_loeta_mean+8*d0_pt_loeta_stddev);
    TH1F *h_dz_pt_loeta = new TH1F("h_dz_pt_loeta", "", 200, dz_pt_loeta_mean-8*dz_pt_loeta_stddev, dz_pt_loeta_mean+8*dz_pt_loeta_stddev);
    TH1F *h_d0_pt_hieta = new TH1F("h_d0_pt_hieta", "", 200, d0_pt_hieta_mean-8*d0_pt_hieta_stddev, d0_pt_hieta_mean+8*d0_pt_hieta_stddev);
    TH1F *h_dz_pt_hieta = new TH1F("h_dz_pt_hieta", "", 200, dz_pt_hieta_mean-8*dz_pt_hieta_stddev, dz_pt_hieta_mean+8*dz_pt_hieta_stddev);

    TH1F *h_d0_eta_lopt = new TH1F("h_d0_eta_lopt", "", 200, d0_eta_lopt_mean-8*d0_eta_lopt_stddev, d0_eta_lopt_mean+8*d0_eta_lopt_stddev);
    TH1F *h_dz_eta_lopt = new TH1F("h_dz_eta_lopt", "", 200, dz_eta_lopt_mean-8*dz_eta_lopt_stddev, dz_eta_lopt_mean+8*dz_eta_lopt_stddev);
    TH1F *h_d0_eta_hipt = new TH1F("h_d0_eta_hipt", "", 200, d0_eta_hipt_mean-8*d0_eta_hipt_stddev, d0_eta_hipt_mean+8*d0_eta_hipt_stddev);
    TH1F *h_dz_eta_hipt = new TH1F("h_dz_eta_hipt", "", 200, dz_eta_hipt_mean-8*dz_eta_hipt_stddev, dz_eta_hipt_mean+8*dz_eta_hipt_stddev);

    TH1F *h_d0_phi_lopt = new TH1F("h_d0_phi_lopt", "", 200, d0_phi_lopt_mean-8*d0_phi_lopt_stddev, d0_phi_lopt_mean+8*d0_phi_lopt_stddev);
    TH1F *h_dz_phi_lopt = new TH1F("h_dz_phi_lopt", "", 200, dz_phi_lopt_mean-8*dz_phi_lopt_stddev, dz_phi_lopt_mean+8*dz_phi_lopt_stddev);
    TH1F *h_d0_phi_hipt = new TH1F("h_d0_phi_hipt", "", 200, d0_phi_hipt_mean-8*d0_phi_hipt_stddev, d0_phi_hipt_mean+8*d0_phi_hipt_stddev);
    TH1F *h_dz_phi_hipt = new TH1F("h_dz_phi_hipt", "", 200, dz_phi_hipt_mean-8*dz_phi_hipt_stddev, dz_phi_hipt_mean+8*dz_phi_hipt_stddev);
    
    
    
    
    
    TH1F *h_d0_pt_loeta = new TH1F("h_d0_pt_loeta", "#splitline{"+ptcut+"}{|#it{#eta}|<1.4};Track IP #it{d_{xy}} (IPPV) [#mum];# tracks", 200, d0_pt_loeta_mean-8*d0_pt_loeta_stddev, d0_pt_loeta_mean+8*d0_pt_loeta_stddev);
    TH1F *h_dz_pt_loeta = new TH1F("h_dz_pt_loeta", "#splitline{"+ptcut+"}{|#it{#eta}|<1.4};Track IP #it{d_{z}} (IPPV) [mm];# tracks", 200, dz_pt_loeta_mean-8*dz_pt_loeta_stddev, dz_pt_loeta_mean+8*dz_pt_loeta_stddev);
    TH1F *h_d0_pt_hieta = new TH1F("h_d0_pt_hieta", "#splitline{"+ptcut+"}{|#it{#eta}|<3.0};Track IP #it{d_{xy}} (IPPV) [#mum];# tracks", 200, d0_pt_hieta_mean-8*d0_pt_hieta_stddev, d0_pt_hieta_mean+8*d0_pt_hieta_stddev);
    TH1F *h_dz_pt_hieta = new TH1F("h_dz_pt_hieta", "#splitline{"+ptcut+"}{|#it{#eta}|<3.0};Track IP #it{d_{z}} (IPPV) [mm];# tracks", 200, dz_pt_hieta_mean-8*dz_pt_hieta_stddev, dz_pt_hieta_mean+8*dz_pt_hieta_stddev);

    TH1F *h_d0_eta_lopt = new TH1F("h_d0_eta_lopt", "#splitline{"+etacut+"}{0.1<#it{p_{T}}<1 GeV};Track IP #it{d_{xy}} (IPPV) [#mum];# tracks", 200, d0_eta_lopt_mean-8*d0_eta_lopt_stddev, d0_eta_lopt_mean+8*d0_eta_lopt_stddev);
    TH1F *h_dz_eta_lopt = new TH1F("h_dz_eta_lopt", "#splitline{"+etacut+"}{0.1<#it{p_{T}}<1 GeV};Track IP #it{d_{z}} (IPPV) [mm];# tracks", 200, dz_eta_lopt_mean-8*dz_eta_lopt_stddev, dz_eta_lopt_mean+8*dz_eta_lopt_stddev);
    TH1F *h_d0_eta_hipt = new TH1F("h_d0_eta_hipt", "#splitline{"+etacut+"}{1<#it{p_{T}}<5 GeV};Track IP #it{d_{xy}} (IPPV) [#mum];# tracks", 200, d0_eta_hipt_mean-8*d0_eta_hipt_stddev, d0_eta_hipt_mean+8*d0_eta_hipt_stddev);
    TH1F *h_dz_eta_hipt = new TH1F("h_dz_eta_hipt", "#splitline{"+etacut+"}{1<#it{p_{T}}<5 GeV};Track IP #it{d_{z}} (IPPV) [mm];# tracks", 200, dz_eta_hipt_mean-8*dz_eta_hipt_stddev, dz_eta_hipt_mean+8*dz_eta_hipt_stddev);

    TH1F *h_d0_phi_lopt = new TH1F("h_d0_phi_lopt", "#splitline{"+phicut+"}{0.1<#it{p_{T}}<1 GeV};Track IP #it{d_{xy}} (IPPV) [#mum];# tracks", 200, d0_phi_lopt_mean-8*d0_phi_lopt_stddev, d0_phi_lopt_mean+8*d0_phi_lopt_stddev);
    TH1F *h_dz_phi_lopt = new TH1F("h_dz_phi_lopt", "#splitline{"+phicut+"}{0.1<#it{p_{T}}<1 GeV};Track IP #it{d_{z}} (IPPV) [mm];# tracks", 200, dz_phi_lopt_mean-8*dz_phi_lopt_stddev, dz_phi_lopt_mean+8*dz_phi_lopt_stddev);
    TH1F *h_d0_phi_hipt = new TH1F("h_d0_phi_hipt", "#splitline{"+phicut+"}{1<#it{p_{T}}<5 GeV};Track IP #it{d_{xy}} (IPPV) [#mum];# tracks", 200, d0_phi_hipt_mean-8*d0_phi_hipt_stddev, d0_phi_hipt_mean+8*d0_phi_hipt_stddev);
    TH1F *h_dz_phi_hipt = new TH1F("h_dz_phi_hipt", "#splitline{"+phicut+"}{1<#it{p_{T}}<5 GeV};Track IP #it{d_{z}} (IPPV) [mm];# tracks", 200, dz_phi_hipt_mean-8*dz_phi_hipt_stddev, dz_phi_hipt_mean+8*dz_phi_hipt_stddev);
