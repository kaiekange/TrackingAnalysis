...
def official_PU_weight(period: str) -> int:
    ...
    mc_files = config[period]["mc"][0]["path"] + "/*.root"

    pileup_hist = f"/eos/home-k/kakang/IPres/analysis/ZeroBias/pileup/{period}/pileupHistogram.root"
    ...
    with open(f"/eos/home-k/kakang/IPres/analysis/ZeroBias/pileup/{period}/pileup_ratio.json", "w") as f:
