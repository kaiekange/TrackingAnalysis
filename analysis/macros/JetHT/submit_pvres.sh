...
for IERA in "${IERAS[@]}"; do
    ...
    rm -rf "/pnfs/iihe/cms/store/user/kakang/IPres/analysis/logs/JetHT/pv_res_${ERA}/PFHT/"
    mkdir -p "/pnfs/iihe/cms/store/user/kakang/IPres/analysis/logs/JetHT/pv_res_${ERA}/PFHT/"
