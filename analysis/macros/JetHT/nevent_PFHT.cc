int nevent_PFHT(){
    ...
    datachain->Add("/pnfs/iihe/cms/store/user/kakang/IPres/analysis/tuples/JetHT/all_skimmed_2022_data_preEE.root");
    ...
    /*     mcchain->Add("/pnfs/iihe/cms/store/user/kakang/IPres/analysis/tuples/JetHT/2022_mc_XsecPSmask/all_skimmed_2022_mc_"+PTranges[i]+"_postEE.root"); */
    /*     /1* int mc_num_1050_pur = mcchain->GetEntries("trig_PFHT1050_pass"); *1/ */
    /*     /1* int mc_num_890_pur = mcchain->GetEntries("trig_PFHT890_pass"); *1/ */
    /*     /1* int mc_num_780_pur = mcchain->GetEntries("trig_PFHT780_pass"); *1/ */
    /*     /1* int mc_num_680_pur = mcchain->GetEntries("trig_PFHT680_pass"); *1/ */
    /*     /1* int mc_num_590_pur = mcchain->GetEntries("trig_PFHT590_pass"); *1/ */
    /*     /1* int mc_num_510_pur = mcchain->GetEntries("trig_PFHT510_pass"); *1/ */
    /*     /1* int mc_num_430_pur = mcchain->GetEntries("trig_PFHT430_pass"); *1/ */
    /*     /1* int mc_num_370_pur = mcchain->GetEntries("trig_PFHT370_pass"); *1/ */
    /*     /1* int mc_num_250_pur = mcchain->GetEntries("trig_PFHT250_pass"); *1/ */
    /*     /1* int mc_num_180_pur = mcchain->GetEntries("trig_PFHT180_pass"); *1/ */
    /*     /1* std::cout << "mc pure " << PTranges[i]  << std::endl; *1/ */
    /*     /1* std::cout << "1050: " << mc_num_1050_pur << std::endl; *1/ */
    /*     /1* std::cout << "890: " << mc_num_890_pur << std::endl; *1/ */
    /*     /1* std::cout << "780: " << mc_num_780_pur << std::endl; *1/ */
    /*     /1* std::cout << "680: " << mc_num_680_pur << std::endl; *1/ */
    /*     /1* std::cout << "590: " << mc_num_590_pur << std::endl; *1/ */
    /*     /1* std::cout << "510: " << mc_num_510_pur << std::endl; *1/ */
    /*     /1* std::cout << "430: " << mc_num_430_pur << std::endl; *1/ */
    /*     /1* std::cout << "370: " << mc_num_370_pur << std::endl; *1/ */
    /*     /1* std::cout << "250: " << mc_num_250_pur << std::endl; *1/ */
    /*     /1* std::cout << "180: " << mc_num_180_pur << std::endl; *1/ */
    ...
    /*     /1* std::cout << "1050: " << mc_num_1050 << std::endl; *1/ */
    /*     /1* std::cout << "890: " << mc_num_890 << std::endl; *1/ */
    /*     /1* std::cout << "780: " << mc_num_780 << std::endl; *1/ */
    /*     /1* std::cout << "680: " << mc_num_680 << std::endl; *1/ */
    /*     /1* std::cout << "590: " << mc_num_590 << std::endl; *1/ */
    /*     /1* std::cout << "510: " << mc_num_510 << std::endl; *1/ */
    /*     /1* std::cout << "430: " << mc_num_430 << std::endl; *1/ */
    /*     /1* std::cout << "370: " << mc_num_370 << std::endl; *1/ */
    /*     /1* std::cout << "250: " << mc_num_250 << std::endl; *1/ */
    /*     /1* std::cout << "180: " << mc_num_180 << "\n" << std::endl; *1/ */
    /* } */
