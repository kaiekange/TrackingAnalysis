...
int draw_ip_res(TString era){
    ...
    compare_gr(gr_data_d0_pt_eta, gr_mc_d0_pt_eta, gr_div_d0_pt_eta, height_d0_pt_eta, floor_d0_pt_eta, pt[0], pt[nbins-1], 0.8, 1.2, "Data", "Simulation", era, "#splitline{"+datatype_text+"}{1.4<|#it{#eta}|<3.0}", "Track #it{p_{T}} [GeV]", "Track IP resolution #it{d_{xy}} [#mum]", figdir + "d0_pt_eta");
    ...
    compare_gr(gr_data_d0_eta_ulpt, gr_mc_d0_eta_ulpt, gr_div_d0_eta_ulpt, height_d0_eta_ulpt, floor_d0_eta_ulpt, eta[0], eta[nbins-1], 0.8, 1.2, "Data", "Simulation", era, "#splitline{"+datatype_text+"}{3.0<#it{p_{T}}<10.0 GeV}", "Track #it{#eta}", "Track IP resolution #it{d_{xy}} [#mum]", figdir + "d0_eta_ulpt");
    ...
    compare_gr(gr_data_d0_phi_ulpt, gr_mc_d0_phi_ulpt, gr_div_d0_phi_ulpt, height_d0_phi_ulpt, floor_d0_phi_ulpt, phi[0], phi[nbins-1], 0.8, 1.2, "Data", "Simulation", era, "#splitline{"+datatype_text+"}{3.0<#it{p_{T}}<10.0 GeV}", "Track #it{#phi}", "Track IP resolution #it{d_{xy}} [#mum]", figdir + "d0_phi_ulpt");
    ...
    compare_gr(gr_data_dz_pt_eta, gr_mc_dz_pt_eta, gr_div_dz_pt_eta, height_dz_pt_eta, floor_dz_pt_eta, pt[0], pt[nbins-1], 0.8, 1.2, "Data", "Simulation", era, "#splitline{"+datatype_text+"}{1.4<|#it{#eta}|<3.0}", "Track #it{p_{T}} [GeV]", "Track IP resolution #it{d_{z}} [#mum]", figdir + "dz_pt_eta");
    ...
    compare_gr(gr_data_dz_eta_ulpt, gr_mc_dz_eta_ulpt, gr_div_dz_eta_ulpt, height_dz_eta_ulpt, floor_dz_eta_ulpt, eta[0], eta[nbins-1], 0.8, 1.2, "Data", "Simulation", era, "#splitline{"+datatype_text+"}{3.0<#it{p_{T}}<10.0 GeV}", "Track #it{#eta}", "Track IP resolution #it{d_{z}} [#mum]", figdir + "dz_eta_ulpt");
    ...
    compare_gr(gr_data_dz_phi_ulpt, gr_mc_dz_phi_ulpt, gr_div_dz_phi_ulpt, height_dz_phi_ulpt, floor_dz_phi_ulpt, phi[0], phi[nbins-1], 0.8, 1.2, "Data", "Simulation", era, "#splitline{"+datatype_text+"}{3.0<#it{p_{T}}<10.0 GeV}", "Track #it{#phi}", "Track IP resolution #it{d_{z}} [#mum]", figdir + "dz_phi_ulpt");
