...
int draw_ip_res(){
    ...
    float reso_d0_eta_ulpt[nbins];
    float reso_dz_eta_ulpt[nbins];

    float reso_d0_phi_lopt[nbins];
    float reso_dz_phi_lopt[nbins];
    float reso_d0_phi_hipt[nbins];
    float reso_dz_phi_hipt[nbins];
    float reso_d0_phi_ulpt[nbins];
    float reso_dz_phi_ulpt[nbins];
    ...
    float reso2_d0_eta_ulpt[nbins];
    float reso2_dz_eta_ulpt[nbins];

    float reso2_d0_phi_lopt[nbins];
    float reso2_dz_phi_lopt[nbins];
    float reso2_d0_phi_hipt[nbins];
    float reso2_dz_phi_hipt[nbins];
    float reso2_d0_phi_ulpt[nbins];
    float reso2_dz_phi_ulpt[nbins];
    ...
    for(int i=0; i<nbins; i++){
        ...
        reso_d0_eta_ulpt[i] = results["reso_d0_eta_ulpt"];
        reso_dz_eta_ulpt[i] = results["reso_dz_eta_ulpt"];
        ...
        reso_d0_phi_ulpt[i] = results["reso_d0_phi_ulpt"];
        reso_dz_phi_ulpt[i] = results["reso_dz_phi_ulpt"];
        ...
        reso2_d0_eta_ulpt[i] = results["reso2_d0_eta_ulpt"];
        reso2_dz_eta_ulpt[i] = results["reso2_dz_eta_ulpt"];
        ...
        reso2_d0_phi_ulpt[i] = results["reso2_d0_phi_ulpt"];
        reso2_dz_phi_ulpt[i] = results["reso2_dz_phi_ulpt"];
    }
    ...
    TGraph * gr_d0_eta_ulpt = new TGraph(nbins, eta, reso_d0_eta_ulpt);
    TGraph * gr_dz_eta_ulpt = new TGraph(nbins, eta, reso_dz_eta_ulpt);
    ...
    TGraph * gr_d0_phi_ulpt = new TGraph(nbins, phi, reso_d0_phi_ulpt);
    TGraph * gr_dz_phi_ulpt = new TGraph(nbins, phi, reso_dz_phi_ulpt);
    ...
    TGraph * gr2_d0_eta_ulpt = new TGraph(nbins, eta, reso2_d0_eta_ulpt);
    TGraph * gr2_dz_eta_ulpt = new TGraph(nbins, eta, reso2_dz_eta_ulpt);
    ...
    TGraph * gr2_d0_phi_ulpt = new TGraph(nbins, phi, reso2_d0_phi_ulpt);
    TGraph * gr2_dz_phi_ulpt = new TGraph(nbins, phi, reso2_dz_phi_ulpt);
    ...
    float height_d0_eta_ulpt = *std::max_element(reso_d0_eta_ulpt, reso_d0_eta_ulpt+nbins);
    float height_dz_eta_ulpt = *std::max_element(reso_dz_eta_ulpt, reso_dz_eta_ulpt+nbins);
    ...
    float height_d0_phi_ulpt = *std::max_element(reso_d0_phi_ulpt, reso_d0_phi_ulpt+nbins);
    float height_dz_phi_ulpt = *std::max_element(reso_dz_phi_ulpt, reso_dz_phi_ulpt+nbins);
    ...
    float height2_d0_eta_ulpt = *std::max_element(reso2_d0_eta_ulpt, reso2_d0_eta_ulpt+nbins);
    float height2_dz_eta_ulpt = *std::max_element(reso2_dz_eta_ulpt, reso2_dz_eta_ulpt+nbins);
    ...
    float height2_d0_phi_ulpt = *std::max_element(reso2_d0_phi_ulpt, reso2_d0_phi_ulpt+nbins);
    float height2_dz_phi_ulpt = *std::max_element(reso2_dz_phi_ulpt, reso2_dz_phi_ulpt+nbins);
    ...
    float floor_d0_eta_ulpt = *std::min_element(reso_d0_eta_ulpt, reso_d0_eta_ulpt+nbins);
    float floor_dz_eta_ulpt = *std::min_element(reso_dz_eta_ulpt, reso_dz_eta_ulpt+nbins);
    ...
    float floor_d0_phi_ulpt = *std::min_element(reso_d0_phi_ulpt, reso_d0_phi_ulpt+nbins);
    float floor_dz_phi_ulpt = *std::min_element(reso_dz_phi_ulpt, reso_dz_phi_ulpt+nbins);
    ...
    float floor2_d0_eta_ulpt = *std::min_element(reso2_d0_eta_ulpt, reso2_d0_eta_ulpt+nbins);
    float floor2_dz_eta_ulpt = *std::min_element(reso2_dz_eta_ulpt, reso2_dz_eta_ulpt+nbins);
    ...
    float floor2_d0_phi_ulpt = *std::min_element(reso2_d0_phi_ulpt, reso2_d0_phi_ulpt+nbins);
    float floor2_dz_phi_ulpt = *std::min_element(reso2_dz_phi_ulpt, reso2_dz_phi_ulpt+nbins);
    ...
    gr_d0_eta_ulpt->SetMarkerStyle(20);
    gr_d0_eta_ulpt->SetMarkerColor(kGreen);
    ...
    leg_d0_eta->AddEntry(gr_d0_eta_ulpt, "3.0<#it{p_{T}}<10.0 GeV", "p");
    ...
    gr_d0_phi_ulpt->SetMarkerStyle(20);
    gr_d0_phi_ulpt->SetMarkerColor(kGreen);
    ...
    leg_d0_phi->AddEntry(gr_d0_phi_ulpt, "3.0<#it{p_{T}}<10.0 GeV", "p");
    ...
    gr2_d0_eta_ulpt->SetMarkerStyle(20);
    gr2_d0_eta_ulpt->SetMarkerColor(kGreen);
    ...
    leg2_d0_eta->AddEntry(gr2_d0_eta_ulpt, "3.0<#it{p_{T}}<10.0 GeV", "p");
    ...
    height2_d0_eta = std::max(height2_d0_eta, height2_d0_eta_ulpt);
    float floor2_d0_eta = std::min(floor2_d0_eta_hipt, floor2_d0_eta_lopt);
    floor2_d0_eta = std::min(floor2_d0_eta, floor2_d0_eta_ulpt);
    ...
    gr2_d0_phi_ulpt->SetMarkerStyle(20);
    gr2_d0_phi_ulpt->SetMarkerColor(kGreen);
    ...
    leg2_d0_phi->AddEntry(gr2_d0_phi_ulpt, "3.0<#it{p_{T}}<10.0 GeV", "p");
    ...
    height2_d0_phi = std::max(height2_d0_phi, height2_d0_phi_ulpt);
    float floor2_d0_phi = std::min(floor2_d0_phi_hipt, floor2_d0_phi_lopt);
    floor2_d0_phi = std::min(floor2_d0_phi, floor2_d0_phi_ulpt);
    ...
    gr_dz_eta_ulpt->SetMarkerStyle(20);
    gr_dz_eta_ulpt->SetMarkerColor(kGreen);
    ...
    leg_dz_eta->AddEntry(gr_dz_eta_ulpt, "3.0<#it{p_{T}}<10.0 GeV", "p");
    ...
    gr_dz_phi_ulpt->SetMarkerStyle(20);
    gr_dz_phi_ulpt->SetMarkerColor(kGreen);
    ...
    leg_dz_phi->AddEntry(gr_dz_phi_ulpt, "3.0<#it{p_{T}}<10.0 GeV", "p");
    ...
    gr2_dz_eta_ulpt->SetMarkerStyle(20);
    gr2_dz_eta_ulpt->SetMarkerColor(kGreen);
    ...
    leg2_dz_eta->AddEntry(gr2_dz_eta_ulpt, "3.0<#it{p_{T}}<10.0 GeV", "p");
    ...
    height2_dz_eta = std::max(height2_dz_eta, height2_dz_eta_ulpt);
    float floor2_dz_eta = std::min(floor2_dz_eta_hipt, floor2_dz_eta_lopt);
    floor2_dz_eta = std::min(floor2_dz_eta, floor2_dz_eta_ulpt);
    ...
    gr2_dz_phi_ulpt->SetMarkerStyle(20);
    gr2_dz_phi_ulpt->SetMarkerColor(kGreen);
    ...
    leg2_dz_phi->AddEntry(gr2_dz_phi_ulpt, "3.0<#it{p_{T}}<10.0 GeV", "p");
    ...
    height2_dz_phi = std::max(height2_dz_phi, height2_dz_phi_ulpt);
    float floor2_dz_phi = std::min(floor2_dz_phi_hipt, floor2_dz_phi_lopt);
    floor2_dz_phi = std::min(floor2_dz_phi, floor2_dz_phi_ulpt);
