...
Int_t compare_ip_res()
{
    ...
    draw_all_graphs(graphs_d0_phi_lopt, height_d0_phi_lopt, "#splitline{" + datatype_text + "}{0.1<#it{p_{T}}<1 GeV}", "Track #it{#phi}", "Track IP resolution #it{d_{xy}} [#mum]", figdir + "d0_phi_lopt.png", false);
    draw_all_graphs(graphs_d0_phi_hipt, height_d0_phi_hipt, "#splitline{" + datatype_text + "}{1<#it{p_{T}}<3 GeV}", "Track #it{#phi}", "Track IP resolution #it{d_{xy}} [#mum]", figdir + "d0_phi_hipt.png", false);
    draw_all_graphs(graphs_d0_phi_ulpt, height_d0_phi_ulpt, "#splitline{" + datatype_text + "}{3<#it{p_{T}}<10 GeV}", "Track #it{#phi}", "Track IP resolution #it{d_{xy}} [#mum]", figdir + "d0_phi_ulpt.png", false);
    draw_all_graphs(graphs_d0_phi_allpt, height_d0_phi_allpt, datatype_text, "Track #it{#phi}", "Track IP resolution #it{d_{xy}} [#mum]", figdir + "d0_phi_allpt.png", false);
    ...
    draw_all_graphs(graphs_dz_phi_lopt, height_dz_phi_lopt, "#splitline{" + datatype_text + "}{0.1<#it{p_{T}}<1 GeV}", "Track #it{#phi}", "Track IP resolution #it{d_{z}} [#mum]", figdir + "dz_phi_lopt.png", false);
    draw_all_graphs(graphs_dz_phi_hipt, height_dz_phi_hipt, "#splitline{" + datatype_text + "}{1<#it{p_{T}}<3 GeV}", "Track #it{#phi}", "Track IP resolution #it{d_{z}} [#mum]", figdir + "dz_phi_hipt.png", false);
    draw_all_graphs(graphs_dz_phi_ulpt, height_dz_phi_ulpt, "#splitline{" + datatype_text + "}{3<#it{p_{T}}<10 GeV}", "Track #it{#phi}", "Track IP resolution #it{d_{z}} [#mum]", figdir + "dz_phi_ulpt.png", false);
    draw_all_graphs(graphs_dz_phi_allpt, height_dz_phi_allpt, datatype_text, "Track #it{#phi}", "Track IP resolution #it{d_{z}} [#mum]", figdir + "dz_phi_allpt.png", false);
