...
void compare_draw(TString era, TTree *datatree, TTree *mctree, TString myvar, TString xtitle, TString ytitle, int nbins, float varmin, float varmax, TString figpath){
    ...
    /* mctree->Project("h2", myvar, "xsecweight * PSweight * cell_mask"); */
    mctree->Project("h2", myvar, "xsecweight * PSweight * cell_mask * PU_factor");
...
int compare_data_mc(TString era){
    ...
    /* compare_draw(era, datatree, mctree, "ev_nPV", "# primary vertices", "Normalised # events", 82, 0.5, 82.5, figdir+"nPV_noPU.png"); */
    /* compare_draw(era, datatree, mctree, "ev_nPV", "# primary vertices", "Normalised # events", 82, 0.5, 82.5, figdir+"nPV.png"); */
